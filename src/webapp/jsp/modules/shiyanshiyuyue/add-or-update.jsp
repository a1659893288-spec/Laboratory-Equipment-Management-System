...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑实验室预约</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>实验室编号</label>
										<input name="shiyanshibianhao" id="shiyanshibianhao" name="shiyanshibianhao" class="form-control" placeholder="实验室编号">
									</div>
									<div class="form-group col-md-6">
										<label>实验室名称</label>
									...
									<div class="form-group col-md-6">
										<label>用户手机</label>
										<input name="yonghushouji" id="yonghushouji" name="yonghushouji" class="form-control" placeholder="用户手机">
									</div>
									<div class="form-group col-md-6">
										<label>预约理由</label>
										<input name="yuyueliyou" id="yuyueliyou" name="yuyueliyou" class="form-control" placeholder="预约理由">
									</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yuyueliyou").val(ruleForm.yuyueliyou);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuyueliyou != null && res.data.yuyueliyou != ''){

						$("#yuyueliyou").val(res.data.yuyueliyou);
						$("#yuyueliyou").attr('readonly','readonly');
					}
