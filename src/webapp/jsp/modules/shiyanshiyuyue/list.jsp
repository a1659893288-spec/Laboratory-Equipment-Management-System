...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>实验室预约管理</span></li>
								<li class="breadcrumb-item active"><span>实验室预约列表</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yuyuebianhaoSearch" class="form-control form-control-sm" placeholder="请输入预约编号" aria-controls="tableId">
									<label>
										实验室编号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yuyueliyou')">预约理由<i id="yuyueliyouIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuyueliyouCell  = document.createElement('td');

						 yuyueliyouCell.innerHTML = item.yuyueliyou;

			row.appendChild(yuyueliyouCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shiyanshiyuyue/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shiyanshiyuyue/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
	...
	function getSum(colName){
		http("shiyanshiyuyue"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"shiyanshiyuyue");
