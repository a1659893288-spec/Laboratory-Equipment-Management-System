...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210724/bd52e0a9568b444baf1197e92d3d2de0.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper h1 {
		...
		border-style: solid;
		border-color: rgba(0,0,0,.3);
		background-color: rgba(14, 43, 75, 1);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		text-align: center;
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<div class="form-group">
							<label class="label">用户手机</label> 
							<input  name="yonghushouji" placeholder="用户手机" class="form-control-i">
							</div>
